...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_user', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Photo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.photo'
        db.delete_column(u'accounts_user', 'photo_id')
