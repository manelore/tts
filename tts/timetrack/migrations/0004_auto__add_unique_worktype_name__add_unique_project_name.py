...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WorkType', fields ['name']
        db.create_unique(u'timetrack_worktype', ['name'])

        # Adding unique constraint on 'Project', fields ['name']
        db.create_unique(u'timetrack_project', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['name']
        db.delete_unique(u'timetrack_project', ['name'])

        # Removing unique constraint on 'WorkType', fields ['name']
        db.delete_unique(u'timetrack_worktype', ['name'])
