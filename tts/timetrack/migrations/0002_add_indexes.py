...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute("""
            CREATE INDEX timetrack_worklog_dates_range
            ON timetrack_worklog
            USING btree (start_at , finish_at)""")
        db.execute("""
            CREATE INDEX timetrack_task_deadline
            ON timetrack_task
            USING btree (deadline)""")

        
    def backwards(self, orm):
        db.execute("""DROP INDEX timetrack_worklog_dates_range""")
        db.execute("""DROP INDEX timetrack_task_deadline""")
