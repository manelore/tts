...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'timetrack_task', 'name',
                      self.gf('django.db.models.fields.CharField')(default=u'task', max_length=100),
                      keep_default=False)
        db.execute("""
        CREATE OR REPLACE VIEW timetrack_task_with_time AS 
        SELECT t.id, t.description, t.estimate, t.deadline, t.project_id, wl.worktime, t.name
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'timetrack_task', 'name')
