...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'timetrack_project', 'description',
                      self.gf('django.db.models.fields.TextField')(default=u'description', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.description'
        db.delete_column(u'timetrack_project', 'description')
