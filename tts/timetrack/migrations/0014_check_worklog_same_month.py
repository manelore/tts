...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        ADD CONSTRAINT timetrack_worklog_check_same_month
        CHECK (extract(month from finish_at) = extract(month from start_at));
        """)

    def backwards(self, orm):
        db.execute("""
        ALTER TABLE timetrack_worklog
        DROP CONSTRAINT timetrack_worklog_check_same_month;
        """)
