...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("""
ALTER TABLE timetrack_worklog
ADD CONSTRAINT timetrack_worklog_check_dates
...
BEGIN
    RETURN EXISTS (
      SELECT * 
      FROM timetrack_project_users AS pu
...
ALTER TABLE timetrack_worklog
ADD CONSTRAINT timetrack_worklog_user_task_check CHECK (timetrack_check_user_task(user_id, task_id));
    ...
    def backwards(self, orm):
        db.execute("""
        ALTER TABLE timetrack_worklog
        DROP CONSTRAINT timetrack_worklog_check_dates;

        ALTER TABLE timetrack_worklog
        DROP CONSTRAINT timetrack_worklog_user_task_check;        

        DROP FUNCTION timetrack_check_user_task(INTEGER, INTEGER);
